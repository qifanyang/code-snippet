...
import test.spring.bean.BeanForAutowiredInject;
import test.spring.bean.BeanForConstructorInject;
import test.spring.bean.BeanForSetInject;
import test.spring.circle.CircleA;
